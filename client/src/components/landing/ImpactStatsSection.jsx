...
const ImpactStatsSection = ({ impactStats = {} }) => {
  const totalReports = (impactStats.totalReports || 1234).toLocaleString();
  const resolvedReports = (impactStats.resolvedReports || 856).toLocaleString();
  const activeUsers = (impactStats.activeUsers || 2456).toLocaleString();
