        ...
        <section className="relative py-20 bg-gradient-to-br from-primary-600 via-primary-700 to-green-700 overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              >
                <div className="flex gap-3 p-2 bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 shadow-2xl">
                  <input
                    type="email"
                    placeholder="Your email address"
                    className="flex-1 px-6 py-4 rounded-xl bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-white/50 font-medium"
                  />
                  <motion.button
                    type="submit"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="bg-gradient-to-r from-green-500 to-green-600 text-white px-8 py-4 rounded-xl font-bold whitespace-nowrap shadow-lg hover:shadow-green-500/50 transition-all"
                  >
                    Subscribe
                  </motion.button>
                </div>
