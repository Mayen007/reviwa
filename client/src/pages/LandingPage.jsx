            ...
            >
              <div className="bg-white rounded-2xl shadow-xl p-8">
                ...
                <p className="text-gray-600 mb-6">
                  Our platform directly supports the United Nations Sustainable
                  Development Goal 11: Making cities inclusive, safe, resilient
                  and sustainable. Every report you make contributes to building
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-700 italic">
                ...
                report and clean up waste. It's education and action combined."
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-700 italic">
                "Reviwa provides invaluable data for urban planning. We can now
                prioritize cleanup efforts based on real community input."
              </p>
            </motion.div>
          </div>
        </div>
