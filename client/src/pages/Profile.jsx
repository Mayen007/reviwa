      ...
      <div className="card">
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center py-3 border-b border-gray-200">
            ...
            <span className="font-semibold text-primary-600">10 pts each</span>
          </div>
          <div className="flex justify-between items-center py-3 border-b border-gray-200">
            <span className="text-gray-700">Points for Verification</span>
            <span className="font-semibold text-primary-600">20 pts each</span>
          </div>
          <div className="flex justify-between items-center py-3">
            <span className="text-gray-700">Points for Resolution</span>
            <span className="font-semibold text-primary-600">50 pts each</span>
          </div>
        </div>
      </div>
    </div>
